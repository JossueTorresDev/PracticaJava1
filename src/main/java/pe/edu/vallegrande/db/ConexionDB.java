...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:14033;database=dbAkiExpress;encrypt=false;sendStringParametersAsUnicode=false;characterEncoding=UTF-8;";
